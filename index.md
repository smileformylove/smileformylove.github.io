...
I believe **compression is to represent the world**. My current research focuses on the representation of multi-modal signals, including image, video, text and audio to verify **everything is embedding** or **everything is thoken**. While my major job now is for image or video processing and accelerate the progress of the deployment for AICodec.
